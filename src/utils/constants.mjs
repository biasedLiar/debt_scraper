...
export const INTRUM_HANDLER_TIMEOUT_MS = 3000000; // 3000 seconds (50 minutes) - Intrum can take a long time to load and extract data, especially for users with many cases 
